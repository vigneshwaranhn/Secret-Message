...
document.getElementById("name").addEventListener("keyup", function() {
    ...
    if (value == "elizabeth olsen") {

        console.log("User entered elizabeth olsen");
        
        const myImage = document.getElementById("myImage");
        
        const imageUrl = `https://raw.githubusercontent.com/vigneshwaranhn/Secret-Message/master/assets/img/img 1.jpg`;
    ...
    if (value == "gal gadot") {
        ...
        console.log("User entered gal gadot");
        
        const myImage = document.getElementById("myImage");
        
        const imageUrl = `https://raw.githubusercontent.com/vigneshwaranhn/Secret-Message/master/assets/img/img 2.jpg`;
